...
local ResizeHit = Create("TextButton", {
    ...
    RunService.RenderStepped:Connect(function()
        if MainFrame and MainFrame.Visible then
            ...
            local frameHeight = WIN_H * currentScale
            local frameWidth = WIN_W * currentScale
    ...
    local TabContainer = Create("ScrollingFrame", {Parent = Sidebar, BackgroundTransparency = 1, Size = UDim2.new(1, -15, 1, -94), Position = UDim2.new(0, 10, 0, 40), ScrollBarThickness = 0})
...
Create("TextLabel", {
    ...
    local function HideWindow()
        ...
        task.delay(0.3, function()
            ...
            BottomDragHitbox.Visible = false
            Sphere.Visible = true
            Tween(Sphere, {Size = UDim2.new(0, 44, 0, 44)}, 0.4)
    ...
    Create("TextLabel", {
        ...
        ZIndex = 6,
                ...
                function Elements:AddToggle(name, default, callback, extra)
                    ...
                    function api:AddKeyPicker(defaultKey)
...
Chip.Size = UDim2.new(0, 44, 0, 16)
                    ...
                    function api:AddColorPicker(defaultColor, colorCb)
                        ...
                        local function apply()
                            ...
                            if colorCb then colorCb(color) end
                        end
                ...
                function Elements:AddKeybind(name, defaultKey, callback, infoData)
                    ...
                    UserInputService.InputBegan:Connect(function(input)
                        ...
                        bind = input.KeyCode
                        Chip.Text = KeyName(bind)
                        if callback then callback(bind.Name) end
                    end)
